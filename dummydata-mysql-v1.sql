...
WHERE (title, region_name, start_date, end_date) IN (
                                                     ('하이큐 팝업', '홍대', '2025-12-01', '2025-12-31'),
                                                     ('블루록 페스티벌', '강남', '2025-11-15', '2025-12-15'),
                                                     ('귀멸의 칼날 전시', '부산', '2025-10-01', '2025-12-31'),
                                                     ('체인소맨 체험존', '대구', '2025-09-01', '2025-12-30'),
                                                     ('애니 종합 팝업', '신촌', '2025-11-20', '2026-01-05')
    );
