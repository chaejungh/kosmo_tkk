...
CREATE TABLE TKK.MEMBER (
                            ...
                            profile_image_url VARCHAR2(511),
                            intro             VARCHAR2(255),
...
CREATE TABLE TKK.store (
                           ...
                           deleted_yn      CHAR(1)        DEFAULT 'N' NOT NULL                  -- 삭제 여부
);

-- 매장 즐겨찾기 (북마크)
CREATE TABLE TKK.store_bookmark (
                                    store_bookmark_id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- PK
...
CREATE TABLE TKK.store_goods (
                                 ...
                                 thumbnail_url   VARCHAR2(511),                                       -- 썸네일 이미지
                                 created_at      DATE DEFAULT SYSDATE,                                -- 등록일
                                 updated_at      DATE,                                                -- 수정일
...
CREATE TABLE TKK.popup_store (
                                 ...
                                 banner_image_url VARCHAR2(511),                                       -- 배너 이미지
...
CREATE TABLE TKK.popup_bookmark (
                                    popup_bookmark_id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- PK
                                    member_id         NUMBER NOT NULL,                      -- 회원 ID
...
CREATE TABLE TKK.main_banner (
                                 ...
                                 image_url       VARCHAR2(511) NOT NULL,                              -- 배너 이미지 URL
...
CREATE TABLE TKK.board_post_image (
                                      ...
                                      post_id     NUMBER NOT NULL,                                     -- 게시글 ID
                                      image_url   VARCHAR2(511) NOT NULL,                              -- 이미지 URL
                                      sort_order  NUMBER DEFAULT 1,                                    -- 정렬 순서
...
CREATE TABLE TKK.trade_bookmark (
                                    trade_bookmark_id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- PK
                                    member_id         NUMBER NOT NULL,                      -- 회원 ID
                                    trade_id          NUMBER NOT NULL,                      -- 거래글 ID
...
CREATE TABLE TKK.trade_chat_room (
                                     ...
                                     buyer_left_yn   CHAR(1)     DEFAULT 'N' NOT NULL,                    -- 구매자 나가기 여부
                                     seller_left_yn  CHAR(1)     DEFAULT 'N' NOT NULL,                    -- 판매자 나가기 여부
