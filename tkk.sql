...
-- ------------------------------------------------------------
-- CREATE TABLE member (
--                         member_id         NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- 회원 PK
--                         login_id          VARCHAR2(50)   NOT NULL UNIQUE,                      -- 로그인 아이디
--                         login_pw          VARCHAR2(255)  NOT NULL,                             -- 비밀번호(암호화)
--                         nickname          VARCHAR2(50)   NOT NULL UNIQUE,                      -- 닉네임
--                         profile_image_url VARCHAR2(255),                                       -- 프로필 이미지 URL
--                         intro             VARCHAR2(255),                                       -- 한 줄 소개
--                         user_level        NUMBER          DEFAULT 1,                           -- 사이트 이용 레벨
--                         email             VARCHAR2(100),                                       -- 이메일
--                         created_at        DATE            DEFAULT SYSDATE,                     -- 가입일
--                         updated_at        DATE,                                                -- 수정일
--                         deleted_yn        CHAR(1)         DEFAULT 'N'                          -- 탈퇴 여부 (Y/N)
-- );
--
-- ------------------------------------------------------------
...
--                                 CONSTRAINT pk_store_bookmark PRIMARY KEY (member_id, store_id),
...
--                                 CONSTRAINT pk_popup_bookmark PRIMARY KEY (member_id, popup_id),
...
--
-- -- 팝업 참여 브랜드
-- CREATE TABLE popup_brand (
--                              brand_id    NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- 브랜드 PK
--                              name        VARCHAR2(100) NOT NULL                               -- 브랜드명
-- );
--
-- -- 팝업스토어 - 브랜드 매핑
-- CREATE TABLE popup_store_brand (
--                                    popup_id    NUMBER NOT NULL,                      -- 팝업 ID
--                                    brand_id    NUMBER NOT NULL,                      -- 브랜드 ID
--                                    CONSTRAINT pk_popup_store_brand PRIMARY KEY (popup_id, brand_id),
--                                    CONSTRAINT fk_psb_popup FOREIGN KEY (popup_id)
--                                        REFERENCES popup_store(popup_id),
--                                    CONSTRAINT fk_psb_brand FOREIGN KEY (brand_id)
--                                        REFERENCES popup_brand(brand_id)
-- );
--
...
--                                 CONSTRAINT pk_board_post_tag PRIMARY KEY (post_id, tag_id),
...
--                             CONSTRAINT pk_board_like PRIMARY KEY (member_id, post_id),
...
--                                 CONSTRAINT pk_board_bookmark PRIMARY KEY (member_id, post_id),
...
--                                 CONSTRAINT pk_trade_bookmark PRIMARY KEY (member_id, trade_id),
...
--                                  trade_id    NUMBER NOT NULL,                                     -- 거래글 ID
--                                  seller_id   NUMBER NOT NULL,                                     -- 판매자 ID
