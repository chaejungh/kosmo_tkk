...
public interface TradeService {
    TradePost createTradePost(TradePost tradePost); //거래글 작성
    ...
    TradePostImage saveTradeimage(TradePost tradePost); //거래글 이미지 저장
    TradePost changetradepost(TradePost tradePost); //거래 상태 변경
}
